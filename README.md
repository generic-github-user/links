...
-   Bash - *some unsolicited advice: if you find yourself nesting more
    than 3 layers of escaped quotes in bash, it\'s time to use Python*
...
-   channels - educational -
    ...
    particularly outstanding samples are listed below - TODO -
    miscellaneous -
