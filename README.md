...
bookmarks[^1]; adorned with my facetious comments and other information
of questionable usefulness. Mostly restricted to tools and resources I
...
-   https://www.rust-lang.org/ - a systems language every serious
...
-   learning
    ...
    -   https://doc.rust-lang.org/rust-by-example/ - a great companion
        to The Book (especially for the impatient, myself included)
...
-   https://github.com/stedolan/jq - a fun and concise functional
    language for wrangling JSON data
-   https://www.gnu.org/software/sed/manual/sed.html - "I love writing
    ...
    deft `sed` use can adequately replace many white-collar jobs with a
    5-line script and it's almost definitely worth learning if you work
    with text at all regularly)
...
-   https://github.com/atom/atom - a decent text editor if you like CSS
    a little too much, have at least 16GB of RAM, and are scared of vim
    -   Packages
...
-   https://code.visualstudio.com/ - a good first approximation if you
    ever find yourself in the unenviable position of having to write
    Java code

#### Vim

-   https://github.com/neovim/neovim - my main text editor; extremely
    efficient and fairly simple to augment with hundreds of tools
    developed by obscenely smart people over the last 30 years
...
-   https://www.blender.org/ - quite literally the best free software
    I've ever used
...
-   https://konsole.kde.org/ - built into KDE and generally pleasant to
    use; plays nicely with [Fira
    Code](https://github.com/tonsky/FiraCode) ligatures
-   https://sw.kovidgoyal.net/kitty/ - a stable and *very*
    well-optimized TE; includes enough shortcuts out of the box to be a
    decent standalone tmux replacement[^2]
...
-   https://todoist.com/ - one of the better todo managers I've worked
    with (was actually my daily driver for almost two years); great for
...
-   https://github.com/ibraheemdev/modern-unix - fast & modern Unix
    command-line tools; in particular, I recommend `lsd`, `fd`,
    `ripgrep`, `jq`, `tldr`, and `zoxide` (some of these have other
    entries scattered about the place)
-   learning
    -   https://missing.csail.mit.edu/ - recommended very highly for
        anyone who uses any Unix shell on a regular basis; comes in both
        video and text form
-   KDE https://kde.org/plasma-desktop/ - my preferred desktop (I
    recommend enabling the "Wobbly Windows" desktop effect)
    -   themes
        -   sweet mars
...
-   https://learnxinyminutes.com/ - "Good Enough" introductions to
...
-   https://en.wikipedia.org/wiki/Neuroevolution - an alright
    introduction to evolutionary methods in ML
-   https://xviniette.github.io/FlappyLearning/
...
-   https://colab.research.google.com/ - Jupyter-like notebook
    ...
    `Runtime > Change runtime type` and set to GPU or TPU; works best
    with larger datasets and batch sizes)

### Miscellanea

-   https://en.wikipedia.org/wiki/Automated\_machine\_learning
...
-   https://web.archive.org/web/20010419182449/http://www.df.lth.se/\~lft/vim/mandelbrot -
...
-   https://www.mersenne.org/,
    https://en.wikipedia.org/wiki/Great\_Internet\_Mersenne\_Prime\_Search
...
-   Cheat sheets
    -   https://tutorial.math.lamar.edu/pdf/calculus\_cheat\_sheet\_all.pdf
    -   https://www.math.utah.edu/\~macarthu/summer15/math2210/calc3\_cheat\_sheet\_onesheet.pdf

### Other

-   https://oeis.org/
-   https://learnxinyminutes.com/docs/set-theory/ - very basic set
    theory introduction
...
-   https://www.youtube.com/channel/UCbfYPyITQ-7l4upoX8nvctg - one of my
    all-time favorites (mainly covers machine learning and computer
    graphics)
...
-   https://chomsky.info/ - various works of the illustrious Noam
    Chomsky (mostly re: politics, though his work in linguistics is also
    seminal)
-   Books
    ...
    -   https://www.historyisaweapon.com/zinnapeopleshistory.html - *A
...
-   History
    -   https://en.wikipedia.org/wiki/Coal\_Wars
-   Blogs
...
[^1]: entries also drawn from my GitHub stars, various conversations
    with friends, memory, etc.

[^2]: By design; see
    https://github.com/kovidgoyal/kitty/issues/391\#issuecomment-638320745
    and https://news.ycombinator.com/item?id=13342516
